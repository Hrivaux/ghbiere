...
<head>
    ...
    <div class="container" id="content2">
      <div class="lists">
        <ul>
          ...
          <li>
            <a href="pages/formulaire.inscription.html" onclick="closelist()"><u>Modification</u></a>
          </li>
        </ul>
      </div>
  ...
  <p class="text-center"></p> Veuillez saisir l\'ID de la personne à supprimé dans la table commande</p>
  <form class="text-center" action="../pages/demandephpC_delete.php" method="POST">
    
       <p>ID </p><input type="number" name="id" size="15" required/> <br><br>

        <p></p>
        <input type="submit" name="envoi" value="Supprimer"/> <input type="reset" >
    ...
    case "F";
      ...
      <p class="text-center"></p> Veuillez saisir l\'ID de la personne à supprimé dans la table Fournisseur</p>
      <form class="text-center" action="../pages/demandephpF_delete.php" method="POST">
      ...
      <p class="text-center"></p> Veuillez saisir l\'ID de la personne à supprimé dans la table Produit</p>
      <form class="text-center" action="../pages/demandephpP_delete.php" method="POST">
      ...
      <p class="text-center"></p> Veuillez saisir l\'ID de la personne à supprimé dans la table utilisateur</p>
      <form class="text-center" action="../pages/demandephpU_delete.php" method="POST">
           <p>ID </p><input type="number" name="identifiant_id" size="15" required/> <br><br>
            <p></p>
            <input type="submit" name="envoi" value="Supprimer" /> <input type="reset" >
